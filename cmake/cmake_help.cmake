...
########################################################################
# helper functions to print target properties
########################################################################

function(PRINT_TARGET_PROPERTY target prop)
  # v for value, d for defined, s for set
  get_property(v TARGET ${target} PROPERTY ${prop})
  get_property(d TARGET ${target} PROPERTY ${prop} DEFINED)
  get_property(s TARGET ${target} PROPERTY ${prop} SET)
  # only produce output for values that are set
  if(s)
    message("target='${target}' prop='${prop}'")
    message("  value='${v}'")
    message("  defined='${d}'")
    message("  set='${s}'")
    message("")
